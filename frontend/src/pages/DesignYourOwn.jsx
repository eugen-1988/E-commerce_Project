...
const DesignYourOwn = () => {
  ...
  useEffect(() => {
    ...
    img.onload = function () {
      ...
      // Scalăm imaginea pe dimensiunea canvasului (800x600)
      fabricBg.scaleToWidth(800);
      fabricBg.scaleToHeight(600);
    };
    ...
    <div className="flex flex-col items-center gap-4 p-4 w-full max-w-screen-xl mx-auto relative">
      ...
      <div className="relative flex flex-col lg:flex-row items-start w-full gap-2">
        <div className="relative border border-gray-400 w-full lg:w-auto">
          ...
          <div
            className="relative w-full max-w-[800px] aspect-[4/3] overflow-hidden bg-no-repeat bg-center bg-contain"
