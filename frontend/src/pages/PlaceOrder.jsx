...
const PlaceOrder = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between fap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
      {/* ------------    Left  Side --------------*/}
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            <div
              ...
              className="flex items-center gap-3 border p-2 px-3 cursor-pointer lg:mr-6"
            >
              <p
